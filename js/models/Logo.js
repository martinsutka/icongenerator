define([
    ...
    Logo.prototype.toJson = function() {
        return {
            ...
            guidesSize: parseInt(this.guidesSize()),
            guidesX: parseInt(this.guidesX()),
            guidesY: parseInt(this.guidesY()),
            iconSize: parseInt(this.iconSize()),
            iconX: parseInt(this.iconX()),
            iconY: parseInt(this.iconY()),
            iconColor: this.iconColor(),
            iconShadowColor: this.iconShadowColor(),
            iconShadowSize: parseInt(this.iconShadowSize()),
            iconShadowIntensity: parseInt(this.iconShadowIntensity()),
            iconSvg: this.iconSvg(),
            isBackgroundTransparent: this.isBackgroundTransparent(),
            backgroundWidth: parseInt(this.backgroundWidth()),
            backgroundHeight: parseInt(this.backgroundHeight()),
            backgroundColor: this.backgroundColor(),
            backgroundLightColor: this.backgroundLightColor(),
            backgroundLightIntensity: parseInt(this.backgroundLightIntensity()),
            ...
            badgeSize: parseInt(this.badgeSize())
        };
    };
